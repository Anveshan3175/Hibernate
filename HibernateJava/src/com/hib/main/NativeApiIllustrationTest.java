 ...
 * https://www.thoughts-on-java.org/hibernate-tips-use-hibernates-native-bootstrapping-api/
 */
public class NativeApiIllustrationTest extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		/* Hibernate loads the configuration file automatically from the classpath when you call the configure method on the 
		 * StandardServiceRegistryBuilder. You can then adapt the configuration programmatically before you call the build method to get a 
		 * ServiceRegistry.
		 */
	...
	public void testBasicUsage() {
		...
		for ( Event event : (List<Event>) result ) {
			System.out.println( "Event (" + event.getTitle() + ") : " + event.getTitle());
		}
		session.getTransaction().commit();
		session.close();
	}
