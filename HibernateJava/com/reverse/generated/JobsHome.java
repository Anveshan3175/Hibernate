 ...
 * @see com.reverse.generated.Jobs
...
public class JobsHome {
	...
	public Jobs merge(Jobs detachedInstance) {
		...
		try {
			Jobs result = (Jobs) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Jobs findById(java.lang.String id) {
		...
		try {
			Jobs instance = (Jobs) sessionFactory.getCurrentSession().get("com.reverse.generated.Jobs", id);
			if (instance == null) {
	...
	public List findByExample(Jobs instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.reverse.generated.Jobs")
