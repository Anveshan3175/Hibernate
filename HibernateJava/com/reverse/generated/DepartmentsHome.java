 ...
 * @see com.reverse.generated.Departments
...
public class DepartmentsHome {
	...
	public Departments findById(short id) {
		...
		try {
			Departments instance = (Departments) sessionFactory.getCurrentSession()
					.get("com.reverse.generated.Departments", id);
			if (instance == null) {
	...
	public List findByExample(Departments instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.reverse.generated.Departments")
