 ...
 * @see com.reverse.generated.Countries
...
public class CountriesHome {
	...
	public Countries findById(java.lang.String id) {
		...
		try {
			Countries instance = (Countries) sessionFactory.getCurrentSession().get("com.reverse.generated.Countries",
					id);
			if (instance == null) {
	...
	public List findByExample(Countries instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.reverse.generated.Countries")
