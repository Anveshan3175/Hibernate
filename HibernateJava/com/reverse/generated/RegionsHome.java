 ...
 * @see com.reverse.generated.Regions
 * @author Hibernate Tools
 */
public class RegionsHome {

	private static final Log log = LogFactory.getLog(RegionsHome.class);
	...
	public Regions merge(Regions detachedInstance) {
		...
		try {
			Regions result = (Regions) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Regions findById(java.math.BigDecimal id) {
		...
		try {
			Regions instance = (Regions) sessionFactory.getCurrentSession().get("com.reverse.generated.Regions", id);
			if (instance == null) {
	...
	public List findByExample(Regions instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.reverse.generated.Regions")
