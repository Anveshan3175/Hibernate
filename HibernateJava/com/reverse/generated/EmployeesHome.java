 ...
 * @see com.reverse.generated.Employees
...
public class EmployeesHome {
	...
	public Employees findById(int id) {
		...
		try {
			Employees instance = (Employees) sessionFactory.getCurrentSession().get("com.reverse.generated.Employees",
					id);
			if (instance == null) {
	...
	public List findByExample(Employees instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.reverse.generated.Employees")
