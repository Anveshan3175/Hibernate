 ...
 * @see com.reverse.generated.Locations
...
public class LocationsHome {
	...
	public Locations merge(Locations detachedInstance) {
		...
		try {
			Locations result = (Locations) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Locations findById(short id) {
		...
		try {
			Locations instance = (Locations) sessionFactory.getCurrentSession().get("com.reverse.generated.Locations",
					id);
			if (instance == null) {
	...
	public List findByExample(Locations instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.reverse.generated.Locations")
