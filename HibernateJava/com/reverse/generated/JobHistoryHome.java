 ...
 * @see com.reverse.generated.JobHistory
 * @author Hibernate Tools
 */
public class JobHistoryHome {

	private static final Log log = LogFactory.getLog(JobHistoryHome.class);
	...
	public JobHistory merge(JobHistory detachedInstance) {
		...
		try {
			JobHistory result = (JobHistory) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public JobHistory findById(com.reverse.generated.JobHistoryId id) {
		log.debug("getting JobHistory instance with id: " + id);
		try {
			JobHistory instance = (JobHistory) sessionFactory.getCurrentSession()
					.get("com.reverse.generated.JobHistory", id);
			if (instance == null) {
	...
	public List findByExample(JobHistory instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.reverse.generated.JobHistory")
